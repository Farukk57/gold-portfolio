...
const T = {
  en: {
    ...
    allTime: 'all time',
    receipt: 'Receipt', attachReceipt: 'Attach receipt (image or PDF)',
    viewReceipt: 'View Receipt',
    errSave: 'Error saving holding',
  ...
  tr: {
    ...
    allTime: 'tüm zamanlarda',
    receipt: 'Fiş/Makbuz', attachReceipt: 'Fiş ekle (görsel veya PDF)',
    viewReceipt: 'Fişi Görüntüle',
    errSave: 'Kayıt hatası',
    loadingChart: 'Yükleniyor…',
  ...
  de: {
    ...
    allTime: 'gesamt',
    receipt: 'Beleg', attachReceipt: 'Beleg anhängen (Bild oder PDF)',
    viewReceipt: 'Beleg anzeigen',
    errSave: 'Fehler beim Speichern',
    loadingChart: 'Wird geladen…',
